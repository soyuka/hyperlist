...
const _itemHeights = Symbol('itemHeights');
const _itemPositions = Symbol('itemPositions');
const _calculatePositions = Symbol('calculatePositions');
const _applyPositions = Symbol('applyPositions');
